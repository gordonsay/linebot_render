    ...
    if event.message.type == "image":
        ...
        response = model.generate_content(
            [
                {
                    "text": """
        請以繁體中文，用朋友聊天的語氣，輕鬆自然、簡短地描述這張照片的內容。
        語氣請保持冷靜友善，不浮誇、不驚嘆，不使用「哇」、「好棒」之類強烈語氣。
        不要提出任何問題。不要使用疑問句。
        
        只需要像朋友看到照片時說的一句自然描述，並用一句短句帶出你理解的氛圍或可能的感覺即可。
        可以隨性加一點屁話，但不要冒犯或過度激動。
        
        示例：
        - 人物照片：看起來蠻悠閒的，都繼續爽不上班沒關係 ~"~
        - 場景照片：整體感覺蠻安靜的，挺適合放鬆，我也想去廢，大師帶一下吼
        - 物品照片：看起來是剛整理好的桌面，很順眼，我家就是垃圾場等級，需要一個家政婦++
        """
                },
                image   # 直接傳 PIL Image
            ]
